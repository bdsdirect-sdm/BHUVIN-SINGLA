...
const AdminDashboard: React.FC = () => {
    ...
    useEffect(() => {
        const fetchCounts = async () => {
            try {
                const response = await api.get(`${Local.GET_ADMIN_DATA}`, {
                    headers: {
        ...
        <div className="dashboard-container">
            ...
            <div className="dashboard-row">
                <div className="dashboard-card">
                    ...
                    <p className="card-value">{counts.totalUsers || 4}</p>
                </div>
                <div className="dashboard-card">
                    <h2 className="card-title">Active Users</h2>
                    <p className="card-value">{counts.activeUsers || 3}</p>
                </div>
                <div className="dashboard-card">
                    <h2 className="card-title">Inactive Users</h2>
                    <p className="card-value">{counts.inactiveUsers || 1}</p>
                </div>
                <div className="dashboard-card">
                    <h2 className="card-title">Total Waves</h2>
                    <p className="card-value">{counts.totalWaves || 6}</p>
                </div>
            </div>
